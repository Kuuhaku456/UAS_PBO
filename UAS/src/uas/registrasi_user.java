...
public class registrasi_user extends javax.swing.JFrame {
    ...
    /**
     * Creates new form _user
     */
    public registrasi_user() {
        initComponents();
        regis_password.setEchoChar('\u2022');
    }
    ...
    private void initComponents() {
        ...
        regis_username = new javax.swing.JTextField();
        jLabel4 = new javax.swing.JLabel();
        regis_password = new javax.swing.JPasswordField();
        ...
        jLabel1.setText("AMPLANG PAK KUMIS");
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        jLabel8.setBackground(new java.awt.Color(255, 255, 102));
        jLabel8.setIcon(new javax.swing.ImageIcon("C:\\Praktikum_PBO\\Tugas Pak Putut\\UAS\\gambar\\amplang_logo.jpg")); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Praktikum_PBO\\Tugas Pak Putut\\UAS\\gambar\\icons8-admin-24.png")); // NOI18N

        regis_username.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addComponent(regis_username, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 46, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(showPasswordCheckBox_admin)
                            .addComponent(regis_password, javax.swing.GroupLayout.PREFERRED_SIZE, 214, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(regis_username, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(regis_password, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(showPasswordCheckBox_admin)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void showPasswordCheckBox_adminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showPasswordCheckBox_adminActionPerformed
        if (showPasswordCheckBox_admin.isSelected()) {
            regis_password.setEchoChar((char) 0); // Show the password
        } else {
            regis_password.setEchoChar('\u2022'); // Hide the password
        }
    }//GEN-LAST:event_showPasswordCheckBox_adminActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        String username = regis_username.getText();
        String pass = new String(regis_password.getPassword());
        Connection conn = Koneksi.getConnection(); 
        if (username.isEmpty()){
            JOptionPane.showMessageDialog(this, "Username cannot be empty", "Registration Error", JOptionPane.ERROR_MESSAGE);
            regis_username.requestFocusInWindow();
            return;
        }
        if (pass.isEmpty()){
            JOptionPane.showMessageDialog(this, "Password cannot be empty", "Registration Error", JOptionPane.ERROR_MESSAGE);
            regis_password.requestFocusInWindow();
            return;
        }
        
        try {
            String checkQuery = "SELECT * FROM tb_users WHERE username=?";
    ...
    private void clearFields(){
        regis_username.setText("");
        regis_password.setText("");
        showPasswordCheckBox_admin.setEnabled(false);
    }
    /**
    ...
    private javax.swing.JPasswordField regis_password;
    private javax.swing.JTextField regis_username;
